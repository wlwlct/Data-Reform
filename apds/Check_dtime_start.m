...
clearvars
cd('E:\F8Se2 July\F8Se2N2\apd full')
allnames=struct2cell(dir('F8Se2*'));
[~,len]=size(allnames);

days=['08172020'; '08202020';'08062020';'08112020';'08102020'; '07262020';'07242020'];
%days=['07242020'];
...
for len_i=1:1:len
    date=regexp(allnames{1,len_i},'\d*\d*2020','match');
    for days_i=1:days_leng
...
%Mol total means sum of lifetime of one molecule
for days_i=1:days_leng
    clearvars loc
...
%Focus on the spectra of each second in SecDtime_matrix
for days_i=1:days_leng
